    ...
    <div id='home'>
        <div className="w-11/12 mx-auto my-32 flex flex-col gap-6 lg:grid grid-cols-2 items-center lg:w-10/12">
            <div className='w-11/12'>
                <h1 className='font-medium text-[35px] md:text-5xl text-black-100 md:leading-[60px]'>Enjoy <span className='text-primary-600'>home made meals</span> far away from home</h1>
